...
#
            ...
            print(best_feature1)
            np.save("tmp/DMF/ActivationsDMF_Layer1_Features.npy", activations_feature1)
            np.save("tmp/DMF/BestImagesDMF_Layer1_Features.npy", best_feature1)
            np.save("tmp/DMF/RandomFiltersIndexDMF_Layer1_Features.npy", filter_index_feature1)
            print("\n")
            
            activations_feature2,best_feature2,filter_index_feature2=DeconvNet.bestActivation2(eval_data[:100],eval_labels[:100])
            print(best_feature2)
            np.save("tmp/DMF/ActivationsDMF_Layer2_Features.npy", activations_feature2)
            np.save("tmp/DMF/BestImagesDMF_Layer2_Features.npy", best_feature2)
            np.save("tmp/DMF/RandomFiltersIndexDMF_Layer2_Features.npy", filter_index_feature2)
            print("\n")
            
            activations_feature3,best_feature3, filter_index_feature3 =DeconvNet.bestActivation3(eval_data[:100],eval_labels[:100])
            print(best_feature3)
            np.save("tmp/DMF/ActivationsDMF_Layer3_Features.npy", activations_feature3)
            np.save("tmp/DMF/BestImagesDMF_Layer3_Features.npy", best_feature3)
            np.save("tmp/DMF/RandomFiltersIndexDMF_Layer3_Features.npy", filter_index_feature3)
            print("\n")
