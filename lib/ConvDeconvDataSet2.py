...
class CnnData2: ##### OBS: only works if stride size = filter size of pooling layer
    ...
    class DeconvData2:
        ...
        def displayFeatures1( self, inputImage, inputLabel, n_best = 3):
            ...
            all_isolations = np.zeros([filters, n_best, 128, 128, 3])
            ...
            return all_isolations, best


        def displayFeatures2( self, inputImage, inputLabel, n_best = 3):
        ...
        def displayFeatures3( self, inputImage, inputLabel, n_best = 3):
